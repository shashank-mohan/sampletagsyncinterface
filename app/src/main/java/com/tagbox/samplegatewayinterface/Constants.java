...
public final class Constants {
    ...
    public static final String INTENT_CHECK_TAGSYNC_SERVICE = "com.tagbox.intent.check.tagsync.service";
    public static final String INTENT_TAGSYNC_RUNNING_STATUS = "com.tagbox.intent.tagsync.running";
